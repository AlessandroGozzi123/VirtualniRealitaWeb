            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    ...
                    <div class="postranni_sloupec">
                      ...
                      <h1>Uložení uživatele - script pro uložení uživatele do DB</h1>
                      <!-- pravy alt+ů -->
                      <?php
                        $login = $_POST["login"];
                        $heslo1 = $_POST["heslo1"];
                        ...
                        if(!($heslo1==$heslo2)) {
                          die("Zadané hesla nejsou stejné");
                        }
                        ...
                        $sql = "INSERT INTO uzivateleDB (login, heslo1, heslo2, email, jmeno, prijmeni, admin) VALUES ('$login', sha1('$heslo1'), sha1('$heslo2'), '$email', '$jmeno', '$prijmeni', '$admin')";

                        $idDotaz = mysqli_query($idSpojeni, $sql) or die(mysqli_error($idSpojeni));
