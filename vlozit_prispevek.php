            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    ...
                    <div class="postranni_sloupec">
                        ...
                        <form action="vlozit_prispevek_script.php" method="post">
                        ...
                        <select name="tema" >
                            ...
                            <option value="odpoved">Odpověď</option>
                            <option value="vzkaz" selected>Vzkaz</option>
                            <option value="navod">Návod</option>
                        </select>
                        </fieldset>
                        <br><br>
                        <textarea name="prispevek" id="" cols="30" rows="10" placeholder="Zde napište Váš příspěvek." style="resize:none"></textarea>
                        <br><br>
